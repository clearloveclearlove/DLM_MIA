# https://arxiv.org/pdf/2406.15968
import random
import numpy as np

from attacks import AbstractAttack
from attacks.utils import compute_nlloss, batch_nlloss
...
class RecallAttack(AbstractAttack):
    ...
    def run(self, dataset: Dataset) -> Dataset:
        # First ensure we have nlloss values
        ...
        ep = 1e-5
        dataset = dataset.map(lambda x: {self.name: x['recall_nlloss'] / (x['nlloss']+ep)})
        return dataset
